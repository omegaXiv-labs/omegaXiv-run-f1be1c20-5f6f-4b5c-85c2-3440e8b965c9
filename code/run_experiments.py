...
def main() -> None:
    ...
    summary: Dict[str, object] = {
        ...
        "tables": [
            ...
            str(tables.claim_table),
            str(floor_table),
        ],
        "datasets": [str(dataset_path)],
        "evidence_mode": {
            "mode": "synthetic_simulation",
            "note": "Metrics are generated by the synthetic simulator in activation_cl_validation.core rather than by direct benchmark training runs.",
        },
